...
## 1.5 Machine-learned interatomic potentials
...
where εᵢ depends on the local environment around atom i — the species and positions of nearby atoms within some cutoff. The model learns a mapping from local environment to atomic energy contribution.
...
*[End of section 1.5 — approximately 7 minutes]*
