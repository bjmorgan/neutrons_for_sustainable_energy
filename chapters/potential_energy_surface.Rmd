...
Cell deformation ($S_1$ to $S_2$) and internal rearrangement ($S_1$ to $S_3$) are independent directions on the potential energy surface.
...
These are low-dimensional slices through a much higher-dimensional space. The full potential energy surface is $E(\mathbf{r})$, where $\mathbf{r}$ represents the positions of all atoms — $3N$ coordinates for $N$ atoms. Every possible configuration of atoms corresponds to a point on this surface; every point has an energy.
