...
The quantities above separate spatial and temporal information: $g(r)$ captures where atoms are relative to each other; MSD and velocity autocorrelation capture how things change in time. The Van Hove correlation function combines both, measuring spatial correlations as a function of time.
